...
class Text_to_Speech:
    ...
    async def polly_tts(self, websocket, text):
        ...
        try:
            response = self.polly_client.synthesize_speech(
                ...
                Text=text,
                Engine='standard',  # Aditi supports only the standard engine
                LanguageCode="en-IN",  # Aditi supports only en-IN
                OutputFormat='mp3',  # Use mp3 for audio output
                VoiceId='Raveena'  # Use the Aditi voice
            )
    ...
    async def process_text(self, websocket, text):
        if text:
            ...
            try:
                ...
                await Text_to_Speech().polly_tts(websocket, response)
            except Exception as e:
