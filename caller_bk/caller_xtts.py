...
#     async def coquiTTS_custom(self, websocket, text):
#         try:
...
class XTTSWrapper:
    ...
    def split_text(self, text, max_length=75):
    ...
    async def coquiTTS(self, text, wait=True):
        ...
        all_audio = [self.process_text_chunk(chunk) for chunk in chunks if chunk]
